...
<%
    ...
    try {
        ...
        if (con == null) {
            ...
            /*
               Earnings per item within a date range:
               - Item i
               - is_in ii (auction_id, item_id)
               - Auction a
               - Transaction_ t (completed sales)
               - Dress / Shoes / Belt subtype tables

               Item type is computed the SAME way as in buyerHome.jsp:
                 CASE on presence of Dress/Shoes/Belt row for that item.
            */
            ...
            String sql =
                ...
                "ORDER BY total_earnings DESC, i.item_id ASC";
...
<div class="box">
    ...
    <p class="subtitle">
        View total earnings and number of sales for each item within a selected date range.
    </p>

    <!-- Date filter -->
    <form method="get" action="adminReportEarningsPerItem.jsp">
        <div class="filters">
    ...
    <div class="range-note">
        Showing sales from <b><%= fromDateStr %></b> to <b><%= toDateStr %></b>.
    ...
    %>
        <p class="msg no-data">No earnings found for any items in this date range.</p>
    <%
        } else {
    %>
        <table>
