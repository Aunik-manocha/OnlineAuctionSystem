...
<html>
<head>
    <title>Earnings per User (Seller)</title>
    <style>
        * {
...
<%
    ...
    try {
        ...
        if (con == null) {
            ...
            /*
               Earnings per end user (seller) within a date range, optional name search:

               User u
               Seller s (marks which users are sellers)
               Transaction_ t (has seller_id, sale_price, transaction_time)
               ...
               Filter:
                 ...
                 AND u.name LIKE ? (if searchName provided)
            */
            ...
            StringBuilder sql = new StringBuilder(
                ...
                "JOIN Transaction_ t ON t.seller_id = s.user_id " +
            ...
            sql.append("ORDER BY total_earnings DESC, u.user_id ASC");

            PreparedStatement ps = con.prepareStatement(sql.toString());

            int paramIndex = 1;
            ps.setDate(paramIndex++, java.sql.Date.valueOf(fromDateStr));
            ps.setDate(paramIndex++, java.sql.Date.valueOf(toDateStr));
...
<div class="box">
    <a class="back" href="adminReportEarningsPerUser.jsp">&laquo; Back to Admin Dashboard</a>

    <h2>Earnings per User (Seller)</h2>
    <p class="subtitle">
        View earnings and sales count for each seller. Use the filters to narrow by date range and seller name.
    </p>

    <!-- Filters -->
    <form method="get" action="adminReportEarningsPerUser.jsp">
        <div class="filters">
            ...
            <div class="filter-group" style="min-width:180px;">
                <label>Search by seller name</label>
    ...
    <div class="range-note">
        Showing sellers with transactions from <b><%= fromDateStr %></b> to <b><%= toDateStr %></b>
    ...
    %>
        <p class="msg no-data">No seller earnings found for this filter.</p>
    <%
        } else {
    %>
        <table>
